...
public class Setting extends javax.swing.JFrame  {
    ...
    private void initComponents() {
        ...
        tfName.setText(MainRun.currentUser.getName());
        ...
        lbUsernameM.setText(MainRun.currentUser.getUsername());
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try {
            ...
            if (password.equals(cPassword)) {
                MainRun.currentUser.setName(name);
                MainRun.currentUser.setPassword(password);
                DataIO.write();
                this.dispose();
            } else {
                throw new Exception();
            }
            switch (MainRun.currentUser.getRole()) {
                case "admin":
