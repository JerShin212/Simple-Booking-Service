...
public class CustomerAppointmentGUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CustomerAppointmentGUI
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerAppointmentGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerAppointmentGUI().setVisible(true);
            }
        });
    }
