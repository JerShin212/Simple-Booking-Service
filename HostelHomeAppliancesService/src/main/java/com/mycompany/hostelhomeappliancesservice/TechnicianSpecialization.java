 ...
 * @author User
 */
public class TechnicianSpecialization extends javax.swing.JFrame {

    /**
     * Creates new form TechnicianSpecialization
     */
    ...
    private void initComponents() {
        ...
        btnSpecialization.setBackground(new java.awt.Color(204, 204, 204));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TechnicianSpecialization.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TechnicianSpecialization().setVisible(true);
            }
        });
    }
